...
def __pars_args__():
    ...
    parser.add_argument('--n_head', type=int, default=2, help="attention head number")
...
if __name__ == "__main__":
    ...
    for i_iter in range(args.n_iter):
        iter_loss = train_fn(model, optimizer, train_dataloader, args, input_embeddings, target_embeddings, neighbor_embeddings, seq_len)
        ...
        if i_iter % args.eval_step == 0:
            iter_eval, saved_weights = eval_fn(model, eval_dataloader, args, input_embeddings, target_embeddings, neighbor_embeddings, seq_len)
