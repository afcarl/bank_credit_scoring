...
def eval(model, eval_dataloader, input_embeddings, target_embeddings,neighbor_embeddings, seq_len, save_rate):
    # EVAL
    performance = 0
    model.eval()
...
def train(model, optimizer, train_dataloader, input_embeddings, target_embeddings,neighbor_embeddings, seq_len):
    # TRAIN
    model.train()
